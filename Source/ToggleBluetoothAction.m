...
- (BOOL)execute:(NSString **)errorString
{
    ...
    // ControlPlaneX attempts to sleep here for 5 seconds to give bluetooth
    // some time to settle.  This check was originally done on the main thread
    // but ControlPlaneX shouldn't block the main thread for that long
    ...
    // and https://github.com/dustinrue/ControlPlaneX/issues/11, thanks to David Jennes for finding
    ...
    // in the least amount of effort, ControlPlaneX simply tries to get the Bluetooth
