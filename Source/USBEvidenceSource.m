...
{
    kern_return_t rc;
    CFMutableDictionaryRef cfprops;
    NSDictionary *props;

    rc = IORegistryEntryCreateCFProperties(*device, &cfprops, kCFAllocatorDefault, kNilOptions);
    if ((rc != kIOReturnSuccess) || !cfprops)
        return NO;
//    *vendor_id = CFDictionaryGetValue(props, CFSTR("idVendor"));
    props = (__bridge NSDictionary*) cfprops;
